...
company defining their own abstractions, the UVM provides a shared abstraction. This makes it possible to quickly
understand an unknown testbench and to reuse parts of it in other projects. It also makes the exchange of
verification components possible and eases the hiring of new verification engineers.
