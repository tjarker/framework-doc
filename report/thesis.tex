...
The \ttt{Config} singleton also provides a \ttt{OverrideType[A,B]} method, where \ttt{B} has to be derived from \ttt{A}. This method affects which type a factory returns.
