...
In the UVM, the sub-phases of the run phases each have their pre and post variant running immediately before and
...
other using \ttt{yield! seq}. For the framework, a call to \ttt{yieldItem(item)} shall produce the item, and return
